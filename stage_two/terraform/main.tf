provider "google" {
  credentials = file("/home/immah/Videos/acquired-rite-440014-v4-35c1eb021440.json") # Replace with your service account key path
...
resource "google_compute_instance" "app_server" {
  ...
  metadata = {
    ssh-keys = "immah:${file("/home/immah/.ssh/new_key.pub")}"  # Add your SSH key here
  }
  ...
  provisioner "remote-exec" {
    ...
    connection {
      type        = "ssh"
      user        = "immah"
      private_key = file("/home/immah/.ssh/new_key") # Replace with your private key path
